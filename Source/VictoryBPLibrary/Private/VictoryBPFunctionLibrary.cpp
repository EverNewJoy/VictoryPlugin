...
void UVictoryBPFunctionLibrary::ClientTravel(UObject* WorldContextrObject, APlayerController* PlayerController, FString MapName, bool bSeamless, FGuid MapPackageGuid)
{
  if(!WorldContextObject) return;
